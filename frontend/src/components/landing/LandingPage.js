      ...
      <div className="landing-page" style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="hero-section" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div className="cta-buttons">
            ...
            <a
              href="https://apps.apple.com/us/app/quickfixai/id6759504103"
              target="_blank"
              rel="noopener noreferrer"
              className="app-store-badge"
              aria-label="Download QuickFixAI on the App Store"
            >
              <svg className="app-store-apple-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true">
